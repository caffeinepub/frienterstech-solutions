...
export class Backend implements backendInterface {
    ...
    async submitForm(arg0: string, arg1: string, arg2: string, arg3: string | null, arg4: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.submitForm(arg0, arg1, arg2, to_candid_opt_n5(this._uploadFile, this._downloadFile, arg3), arg4);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
